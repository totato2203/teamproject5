...
<div class="container">
	<form id="frm01" class="form-inline"  method="post">
		...
		<input class="form-control mr-sm-2" name="freeTitle" type="text" placeholder="검색어 입력..."
			size="10" value="${freeboard.freeTitle }"/>
		<input class="form-control mr-sm-2" name="freeWriter" type="text" placeholder="검색어 입력..."
